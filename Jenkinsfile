    ...
    stages {
        stage('Create web directory')
        {
            input {
              ...
              parameters {
                    string(name:'AUTHOR', defaultValue: 'LuisGe', description: 'Author of the web application deployment ')
            ...
            steps{
                ...
                sh 'rm -rf /var/container-data/web'
                //Create the directory
                sh 'mkdir /var/container-data/web'
        ...
        stage('Create the Apache httpd container') {
            ...
            sh 'docker run -dit --name apache1 -p 9000:80  -v /var/container-data/web:/usr/local/apache2/htdocs/ httpd'
            }
        }
